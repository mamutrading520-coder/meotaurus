"""Notes management tool service.

This module owns the manage_notes tool implementation.

Temporary compatibility note:
the implementation is intentionally moved mechanically first. Behavior changes
such as owner normalization, rollback handling, due-date validation, checklist
validation, or ambiguous ID handling should be done in later, separate commits.
"""
